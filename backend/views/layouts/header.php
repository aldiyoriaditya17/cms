...
<body class="">
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="red" data-image="<?=$baseUrl?>/ism/assets/img/sidebar-1.jpg">
      <!--
              ...
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?=$baseUrl?>/index.php?r=posting%2Findex">
                    ...
                    <span class="sidebar-normal"> Report Posting </span>
                  </a>
                </li>
                <li class="nav-item ">
